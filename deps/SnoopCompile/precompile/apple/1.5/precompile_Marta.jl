...
function _precompile_()
    ...
    Base.precompile(Tuple{Marta.CTImages.var"#164#threadsfor_fun#13"{Float32,StepRangeLen{Float32,Float64,Float64},StepRangeLen{Float32,Float64,Float64},Float32,Float32,Marta.Interpolation.var"#1#2"{Array{Float32,2},Marta.Interpolation.BilinearInterpolation},Array{Tuple{Int64,Int64},1},Array{Float32,2},Base.OneTo{Int64}}})
