...
function _precompile_()
    ...
    Base.precompile(Tuple{Type{CTImage},Array{Float32,2}})
    ...
    Base.precompile(Tuple{Type{CTScanner{FBP,M} where M},FanBeamGeometry{Float32,DefaultTomograph},GrayScalePyramid{Float32}})
    Base.precompile(Tuple{Type{CTScanner{FBP,M} where M},FanBeamGeometry{Float32,DefaultTomograph},WhiteRect{Float32}})
    Base.precompile(Tuple{Type{CTScanner{FBP,M} where M},FanBeamGeometry{Float64,DefaultTomograph},GrayScaleLine{Float64}})
    ...
    Base.precompile(Tuple{typeof(calibrate_tomogram),CTScanner{FBP{FanBeamGeometry{Float32,DefaultTomograph},Marta.RadonAlgorithm.Filters.RamLak},Array{Float32,2}},WhiteRect{Float32}})
    Base.precompile(Tuple{typeof(calibrate_tomogram),CTScanner{FBP{FanBeamGeometry{Float64,DefaultTomograph},Marta.RadonAlgorithm.Filters.RamLak},Array{Float64,2}},GrayScalePyramid{Float64}})
    ...
    let fbody = try __lookup_kwbody__(which(calibrate_tomogram, (CTScanner{FBP{ParallelBeamGeometry{Float32,DefaultTomograph},Marta.RadonAlgorithm.Filters.RamLak},Array{Float32,2}},CircleImage{Float32},))) catch missing end
        if !ismissing(fbody)
            precompile(fbody, (Base.Iterators.Pairs{Union{},Union{},Tuple{},NamedTuple{(),Tuple{}}},typeof(calibrate_tomogram),CTScanner{FBP{ParallelBeamGeometry{Float32,DefaultTomograph},Marta.RadonAlgorithm.Filters.RamLak},Array{Float32,2}},CircleImage{Float32},))
        end
    end
end
