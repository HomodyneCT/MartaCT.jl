...
function _precompile_()
    ...
    let fbody = try __lookup_kwbody__(which(calibrate_tomogram, (CTScanner{FBPInfo{FanBeamGeometry{Float32,DefaultTomograph},FBP{MartaCT.RadonAlgorithm.Filters.RamLak}},MartaCT.CTScan.CTImageData.CTData{Float32,Array{Float32,2}}},SquareImage{Float32},))) catch missing end
        if !ismissing(fbody)
            precompile(fbody, (Base.Iterators.Pairs{Union{},Union{},Tuple{},NamedTuple{(),Tuple{}}},typeof(calibrate_tomogram),CTScanner{FBPInfo{FanBeamGeometry{Float32,DefaultTomograph},FBP{MartaCT.RadonAlgorithm.Filters.RamLak}},MartaCT.CTScan.CTImageData.CTData{Float32,Array{Float32,2}}},SquareImage{Float32},))
        end
    end
