...
function _precompile_()
    ...
    Base.precompile(Tuple{Core.kwftype(typeof(Type)),NamedTuple{(:name, :study_id),Tuple{Symbol,String}},Type{CTScanner},FBPInfo{ParallelBeamGeometry{Float32,DefaultTomograph},FBP{MartaCT.RadonAlgorithm.Filters.RamLak}},MartaCT.CTScan.CTImageData.CTData{Float32,Array{Float32,2}}})
    ...
    Base.precompile(Tuple{Core.kwftype(typeof(Type)),NamedTuple{(:width, :height, :nϕ),Tuple{Int64,Int64,Int64}},Type{ParallelBeamGeometry},Type{Float32}})
    ...
    Base.precompile(Tuple{MartaCT.CTImages.var"#161#threadsfor_fun#13"{Float32,Float32,StepRangeLen{Float32,Float64,Float64},StepRangeLen{Float32,Float64,Float64},Int64,Rational{Int64},MartaCT.Interpolation.var"#1#2"{Array{Float32,2},MartaCT.Interpolation.BilinearInterpolation},Array{Float32,2},Base.OneTo{Int64}}})
    Base.precompile(Tuple{MartaCT.CTImages.var"#161#threadsfor_fun#13"{Float32,Float32,StepRangeLen{Float32,Float64,Float64},StepRangeLen{Float32,Float64,Float64},Int64,Rational{Int64},MartaCT.Interpolation.var"#1#2"{Array{Float32,2},MartaCT.Interpolation.NoInterpolation},Array{Float32,2},Base.OneTo{Int64}}})
    Base.precompile(Tuple{MartaCT.CTImages.var"#161#threadsfor_fun#13"{Float64,Float64,StepRangeLen{Float64,Base.TwicePrecision{Float64},Base.TwicePrecision{Float64}},StepRangeLen{Float64,Base.TwicePrecision{Float64},Base.TwicePrecision{Float64}},Int64,Rational{Int64},MartaCT.Interpolation.var"#1#2"{Array{Float64,2},MartaCT.Interpolation.BilinearInterpolation},Array{Float64,2},Base.OneTo{Int64}}})
    Base.precompile(Tuple{MartaCT.CTImages.var"#161#threadsfor_fun#13"{Float64,Float64,StepRangeLen{Float64,Base.TwicePrecision{Float64},Base.TwicePrecision{Float64}},StepRangeLen{Float64,Base.TwicePrecision{Float64},Base.TwicePrecision{Float64}},Int64,Rational{Int64},MartaCT.Interpolation.var"#1#2"{Array{Float64,2},MartaCT.Interpolation.NoInterpolation},Array{Float64,2},Base.OneTo{Int64}}})
    Base.precompile(Tuple{MartaCT.FanBeam.var"#191#threadsfor_fun#3"{Float32,Int64,Float32,StepRangeLen{Float32,Float64,Float64},StepRangeLen{Float32,Float64,Float64},CTSinogram{Float32,Array{Float32,2}},MartaCT.FanBeam.var"#compute_value#2"{Float32,Int64,Int64,Float32,Float32,Float32,Rational{Int64},MartaCT.Interpolation.var"#1#2"{CTSinogram{Float32,Array{Float32,2}},MartaCT.Interpolation.BilinearInterpolation},Float32},UnitRange{Int64}}})
    Base.precompile(Tuple{MartaCT.FanBeam.var"#191#threadsfor_fun#3"{Float64,Int64,Float64,StepRangeLen{Float64,Base.TwicePrecision{Float64},Base.TwicePrecision{Float64}},StepRangeLen{Float64,Base.TwicePrecision{Float64},Base.TwicePrecision{Float64}},CTSinogram{Float64,Array{Float64,2}},MartaCT.FanBeam.var"#compute_value#2"{Float64,Int64,Int64,Float64,Float64,Float64,Rational{Int64},MartaCT.Interpolation.var"#1#2"{CTSinogram{Float64,Array{Float64,2}},MartaCT.Interpolation.BilinearInterpolation},Float64},UnitRange{Int64}}})
    Base.precompile(Tuple{MartaCT.FanBeam.var"#214#threadsfor_fun#10"{Float32,Int64,Float32,StepRangeLen{Float32,Float64,Float64},Float32,StepRangeLen{Float32,Float64,Float64},CTSinogram{Float32,Array{Float32,2}},MartaCT.FanBeam.var"#compute_value#9"{Float32,Int64,Int64,Float32,Float32,Float32,MartaCT.Interpolation.var"#1#2"{CTSinogram{Float32,Array{Float32,2}},MartaCT.Interpolation.BilinearInterpolation},Float32,Rational{Int64}},UnitRange{Int64}}})
    Base.precompile(Tuple{MartaCT.FanBeam.var"#214#threadsfor_fun#10"{Float64,Int64,Float64,StepRangeLen{Float64,Base.TwicePrecision{Float64},Base.TwicePrecision{Float64}},Float64,StepRangeLen{Float64,Base.TwicePrecision{Float64},Base.TwicePrecision{Float64}},CTSinogram{Float64,Array{Float64,2}},MartaCT.FanBeam.var"#compute_value#9"{Float64,Int64,Int64,Float64,Float64,Float64,MartaCT.Interpolation.var"#1#2"{CTSinogram{Float64,Array{Float64,2}},MartaCT.Interpolation.BilinearInterpolation},Float64,Rational{Int64}},UnitRange{Int64}}})
    ...
    Base.precompile(Tuple{Type{CTScanner{FBPInfo{G,A} where A<:AbstractFBP,D} where D where G},GrayScaleLine{Float32}})
    ...
    Base.precompile(Tuple{Type{CTScanner{FBPInfo{G,A} where A<:AbstractFBP,D} where D where G},SquareImage{Float32}})
    Base.precompile(Tuple{Type{CTScanner{FBPInfo{G,A} where A<:AbstractFBP,D} where D where G},SquareImage{Float64}})
    ...
    Base.precompile(Tuple{typeof(calibrate_tomogram),CTScanner{FBPInfo{FanBeamGeometry{Float32,DefaultTomograph},FBP{MartaCT.RadonAlgorithm.Filters.RamLak}},MartaCT.CTScan.CTImageData.CTData{Float32,Array{Float32,2}}},CircleImage{Float32}})
    Base.precompile(Tuple{typeof(calibrate_tomogram),CTScanner{FBPInfo{ParallelBeamGeometry{Float32,DefaultTomograph},FBP{MartaCT.RadonAlgorithm.Filters.RamLak}},MartaCT.CTScan.CTImageData.CTData{Float32,Array{Float32,2}}},CircleImage{Float32}})
    Base.precompile(Tuple{typeof(calibrate_tomogram),CTScanner{FBPInfo{ParallelBeamGeometry{Float32,DefaultTomograph},FBP{MartaCT.RadonAlgorithm.Filters.RamLak}},MartaCT.CTScan.CTImageData.CTData{Float32,Array{Float32,2}}},CircleParams{Float32}})
    Base.precompile(Tuple{typeof(calibrate_tomogram),CTScanner{FBPInfo{ParallelBeamGeometry{Float32,DefaultTomograph},FBP{MartaCT.RadonAlgorithm.Filters.RamLak}},MartaCT.CTScan.CTImageData.CTData{Float32,Array{Float32,2}}},ImageParams{Float32}})
    Base.precompile(Tuple{typeof(calibrate_tomogram),CTScanner{FBPInfo{ParallelBeamGeometry{Float32,DefaultTomograph},FBP{MartaCT.RadonAlgorithm.Filters.RamLak}},MartaCT.CTScan.CTImageData.CTData{Float32,Array{Float32,2}}},MartaCT.TestImages.SquareParams{Float32}})
    Base.precompile(Tuple{typeof(calibrate_tomogram),CTScanner{FBPInfo{ParallelBeamGeometry{Float64,DefaultTomograph},FBP{MartaCT.RadonAlgorithm.Filters.RamLak}},MartaCT.CTScan.CTImageData.CTData{Float64,Array{Float64,2}}},CircleImage{Float64}})
    Base.precompile(Tuple{typeof(calibrate_tomogram),CTScanner{FBPInfo{ParallelBeamGeometry{Float64,DefaultTomograph},FBP{MartaCT.RadonAlgorithm.Filters.RamLak}},MartaCT.CTScan.CTImageData.CTData{Float64,Array{Float64,2}}},CircleParams{Float64}})
    Base.precompile(Tuple{typeof(calibrate_tomogram),CTScanner{FBPInfo{ParallelBeamGeometry{Float64,DefaultTomograph},FBP{MartaCT.RadonAlgorithm.Filters.RamLak}},MartaCT.CTScan.CTImageData.CTData{Float64,Array{Float64,2}}},ImageParams{Float64}})
    Base.precompile(Tuple{typeof(calibrate_tomogram),CTScanner{FBPInfo{ParallelBeamGeometry{Float64,DefaultTomograph},FBP{MartaCT.RadonAlgorithm.Filters.RamLak}},MartaCT.CTScan.CTImageData.CTData{Float64,Array{Float64,2}}},MartaCT.TestImages.SquareParams{Float64}})
    ...
    let fbody = try __lookup_kwbody__(which(calibrate_tomogram, (CTScanner{FBPInfo{ParallelBeamGeometry{Float32,DefaultTomograph},FBP{MartaCT.RadonAlgorithm.Filters.RamLak}},MartaCT.CTScan.CTImageData.CTData{Float32,Array{Float32,2}}},CircleImage{Float32},))) catch missing end
        if !ismissing(fbody)
            precompile(fbody, (Base.Iterators.Pairs{Union{},Union{},Tuple{},NamedTuple{(),Tuple{}}},typeof(calibrate_tomogram),CTScanner{FBPInfo{ParallelBeamGeometry{Float32,DefaultTomograph},FBP{MartaCT.RadonAlgorithm.Filters.RamLak}},MartaCT.CTScan.CTImageData.CTData{Float32,Array{Float32,2}}},CircleImage{Float32},))
        end
    end
    let fbody = try __lookup_kwbody__(which(polar2cart, (Array{Float32,2},StepRangeLen{Float32,Float64,Float64},StepRangeLen{Float32,Float64,Float64},))) catch missing end
        if !ismissing(fbody)
            precompile(fbody, (Int64,Nothing,Bool,Float32,Bool,MartaCT.Interpolation.NoInterpolation,typeof(polar2cart),Array{Float32,2},StepRangeLen{Float32,Float64,Float64},StepRangeLen{Float32,Float64,Float64},))
        end
    end
    let fbody = try __lookup_kwbody__(which(polar2cart, (Array{Float32,2},StepRangeLen{Float32,Float64,Float64},StepRangeLen{Float32,Float64,Float64},))) catch missing end
        if !ismissing(fbody)
    ...
    let fbody = try __lookup_kwbody__(which(polar2cart, (Array{Float64,2},StepRangeLen{Float64,Base.TwicePrecision{Float64},Base.TwicePrecision{Float64}},StepRangeLen{Float64,Base.TwicePrecision{Float64},Base.TwicePrecision{Float64}},))) catch missing end
        if !ismissing(fbody)
            precompile(fbody, (Int64,Nothing,Bool,Float64,Bool,MartaCT.Interpolation.NoInterpolation,typeof(polar2cart),Array{Float64,2},StepRangeLen{Float64,Base.TwicePrecision{Float64},Base.TwicePrecision{Float64}},StepRangeLen{Float64,Base.TwicePrecision{Float64},Base.TwicePrecision{Float64}},))
        end
    end
    let fbody = try __lookup_kwbody__(which(polar2cart, (Array{Float64,2},StepRangeLen{Float64,Base.TwicePrecision{Float64},Base.TwicePrecision{Float64}},StepRangeLen{Float64,Base.TwicePrecision{Float64},Base.TwicePrecision{Float64}},))) catch missing end
        if !ismissing(fbody)
