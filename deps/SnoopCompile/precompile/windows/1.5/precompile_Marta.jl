...
function _precompile_()
    ...
    let fbody = try __lookup_kwbody__(which(calibrate_tomogram, (CTScanner{FBPInfo{FanBeamGeometry{Float64,DefaultTomograph},FBP{Marta.RadonAlgorithm.Filters.RamLak}},Marta.CTScan.CTImageData.CTData{Float64,Array{Float64,2}}},WhiteRect{Float64},))) catch missing end
        if !ismissing(fbody)
            precompile(fbody, (Base.Iterators.Pairs{Union{},Union{},Tuple{},NamedTuple{(),Tuple{}}},typeof(calibrate_tomogram),CTScanner{FBPInfo{FanBeamGeometry{Float64,DefaultTomograph},FBP{Marta.RadonAlgorithm.Filters.RamLak}},Marta.CTScan.CTImageData.CTData{Float64,Array{Float64,2}}},WhiteRect{Float64},))
        end
    end
