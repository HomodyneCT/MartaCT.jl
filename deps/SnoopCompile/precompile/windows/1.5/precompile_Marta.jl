...
function _precompile_()
    ...
    Base.precompile(Tuple{Core.kwftype(typeof(Type)),NamedTuple{(:name, :study_id),Tuple{Symbol,String}},Type{CTScanner},FBPInfo{FanBeamGeometry{Float64,DefaultTomograph},FBP{Marta.RadonAlgorithm.Filters.RamLak}},Marta.CTScan.CTImageData.CTData{Float64,Array{Float64,2}}})
    ...
    Base.precompile(Tuple{Core.kwftype(typeof(Type)),NamedTuple{(:width, :height),Tuple{Int64,Int64}},Type{ParallelBeamGeometry},Type{Float64}})
    ...
    Base.precompile(Tuple{Marta.CTImages.var"#153#threadsfor_fun#15"{Float32,Int64,Int64,Float32,Float32,Marta.Interpolation.var"#1#2"{Array{Float32,2},Marta.Interpolation.BilinearInterpolation},Marta.CTImages.var"#13#14"{Float32},StepRangeLen{Float32,Float64,Float64},StepRangeLen{Float32,Float64,Float64},Array{Tuple{Int64,Int64},1},Array{Float32,2},Base.OneTo{Int64}}})
    Base.precompile(Tuple{Marta.CTImages.var"#153#threadsfor_fun#15"{Float32,Int64,Int64,Float32,Float32,Marta.Interpolation.var"#1#2"{Array{Float32,2},Marta.Interpolation.NoInterpolation},Marta.CTImages.var"#13#14"{Float32},StepRangeLen{Float32,Float64,Float64},StepRangeLen{Float32,Float64,Float64},Array{Tuple{Int64,Int64},1},Array{Float32,2},Base.OneTo{Int64}}})
    Base.precompile(Tuple{Marta.CTImages.var"#153#threadsfor_fun#15"{Float64,Int64,Int64,Float64,Float64,Marta.Interpolation.var"#1#2"{Array{Float64,2},Marta.Interpolation.BilinearInterpolation},Marta.CTImages.var"#13#14"{Float64},StepRangeLen{Float64,Base.TwicePrecision{Float64},Base.TwicePrecision{Float64}},StepRangeLen{Float64,Base.TwicePrecision{Float64},Base.TwicePrecision{Float64}},Array{Tuple{Int64,Int64},1},Array{Float64,2},Base.OneTo{Int64}}})
    Base.precompile(Tuple{Marta.CTImages.var"#153#threadsfor_fun#15"{Float64,Int64,Int64,Float64,Float64,Marta.Interpolation.var"#1#2"{Array{Float64,2},Marta.Interpolation.NoInterpolation},Marta.CTImages.var"#13#14"{Float64},StepRangeLen{Float64,Base.TwicePrecision{Float64},Base.TwicePrecision{Float64}},StepRangeLen{Float64,Base.TwicePrecision{Float64},Base.TwicePrecision{Float64}},Array{Tuple{Int64,Int64},1},Array{Float64,2},Base.OneTo{Int64}}})
    Base.precompile(Tuple{Marta.FanBeam.var"#176#threadsfor_fun#3"{Float32,Int64,Float32,Float32,Float32,Float32,Float32,CTSinogram{Float32,Array{Float32,2}},Marta.FanBeam.var"#compute_value#2"{Float32,Int64,Int64,Float32,Float32,Float32,Marta.Interpolation.var"#1#2"{CTSinogram{Float32,Array{Float32,2}},Marta.Interpolation.BilinearInterpolation},Float32},UnitRange{Int64}}})
    Base.precompile(Tuple{Marta.FanBeam.var"#176#threadsfor_fun#3"{Float64,Int64,Float64,Float64,Float64,Float64,Float64,CTSinogram{Float64,Array{Float64,2}},Marta.FanBeam.var"#compute_value#2"{Float64,Int64,Int64,Float64,Float64,Float64,Marta.Interpolation.var"#1#2"{CTSinogram{Float64,Array{Float64,2}},Marta.Interpolation.BilinearInterpolation},Float64},UnitRange{Int64}}})
    Base.precompile(Tuple{Marta.FanBeam.var"#195#threadsfor_fun#10"{Float32,Int64,Float32,Float32,Float32,Float32,Float32,CTSinogram{Float32,Array{Float32,2}},Marta.FanBeam.var"#compute_value#9"{Float32,Int64,Int64,Float32,Float32,Float32,Marta.Interpolation.var"#1#2"{CTSinogram{Float32,Array{Float32,2}},Marta.Interpolation.BilinearInterpolation},Float32},UnitRange{Int64}}})
    Base.precompile(Tuple{Marta.FanBeam.var"#195#threadsfor_fun#10"{Float64,Int64,Float64,Float64,Float64,Float64,Float64,CTSinogram{Float64,Array{Float64,2}},Marta.FanBeam.var"#compute_value#9"{Float64,Int64,Int64,Float64,Float64,Float64,Marta.Interpolation.var"#1#2"{CTSinogram{Float64,Array{Float64,2}},Marta.Interpolation.BilinearInterpolation},Float64},UnitRange{Int64}}})
    ...
    Base.precompile(Tuple{typeof(calibrate_tomogram),CTScanner{FBPInfo{FanBeamGeometry{Float32,DefaultTomograph},FBP{Marta.RadonAlgorithm.Filters.RamLak}},Marta.CTScan.CTImageData.CTData{Float32,Array{Float32,2}}},CircleImage{Float32}})
    Base.precompile(Tuple{typeof(calibrate_tomogram),CTScanner{FBPInfo{FanBeamGeometry{Float32,DefaultTomograph},FBP{Marta.RadonAlgorithm.Filters.RamLak}},Marta.CTScan.CTImageData.CTData{Float32,Array{Float32,2}}},CircleParams{Float32}})
    ...
    let fbody = try __lookup_kwbody__(which(calibrate_tomogram, (CTScanner{FBPInfo{FanBeamGeometry{Float32,DefaultTomograph},FBP{Marta.RadonAlgorithm.Filters.RamLak}},Marta.CTScan.CTImageData.CTData{Float32,Array{Float32,2}}},WhiteRect{Float32},))) catch missing end
        if !ismissing(fbody)
            precompile(fbody, (Base.Iterators.Pairs{Union{},Union{},Tuple{},NamedTuple{(),Tuple{}}},typeof(calibrate_tomogram),CTScanner{FBPInfo{FanBeamGeometry{Float32,DefaultTomograph},FBP{Marta.RadonAlgorithm.Filters.RamLak}},Marta.CTScan.CTImageData.CTData{Float32,Array{Float32,2}}},WhiteRect{Float32},))
        end
    end
    let fbody = try __lookup_kwbody__(which(calibrate_tomogram, (CTScanner{FBPInfo{ParallelBeamGeometry{Float32,DefaultTomograph},FBP{Marta.RadonAlgorithm.Filters.RamLak}},Marta.CTScan.CTImageData.CTData{Float32,Array{Float32,2}}},GrayScaleLine{Float32},))) catch missing end
        if !ismissing(fbody)
            precompile(fbody, (Base.Iterators.Pairs{Union{},Union{},Tuple{},NamedTuple{(),Tuple{}}},typeof(calibrate_tomogram),CTScanner{FBPInfo{ParallelBeamGeometry{Float32,DefaultTomograph},FBP{Marta.RadonAlgorithm.Filters.RamLak}},Marta.CTScan.CTImageData.CTData{Float32,Array{Float32,2}}},GrayScaleLine{Float32},))
        end
    end
    let fbody = try __lookup_kwbody__(which(calibrate_tomogram, (CTScanner{FBPInfo{ParallelBeamGeometry{Float32,DefaultTomograph},FBP{Marta.RadonAlgorithm.Filters.RamLak}},Marta.CTScan.CTImageData.CTData{Float32,Array{Float32,2}}},GrayScalePyramid{Float32},))) catch missing end
        if !ismissing(fbody)
            precompile(fbody, (Base.Iterators.Pairs{Union{},Union{},Tuple{},NamedTuple{(),Tuple{}}},typeof(calibrate_tomogram),CTScanner{FBPInfo{ParallelBeamGeometry{Float32,DefaultTomograph},FBP{Marta.RadonAlgorithm.Filters.RamLak}},Marta.CTScan.CTImageData.CTData{Float32,Array{Float32,2}}},GrayScalePyramid{Float32},))
        end
    end
    let fbody = try __lookup_kwbody__(which(calibrate_tomogram, (CTScanner{FBPInfo{ParallelBeamGeometry{Float64,DefaultTomograph},FBP{Marta.RadonAlgorithm.Filters.RamLak}},Marta.CTScan.CTImageData.CTData{Float64,Array{Float64,2}}},CircleImage{Float64},))) catch missing end
        if !ismissing(fbody)
            precompile(fbody, (Base.Iterators.Pairs{Union{},Union{},Tuple{},NamedTuple{(),Tuple{}}},typeof(calibrate_tomogram),CTScanner{FBPInfo{ParallelBeamGeometry{Float64,DefaultTomograph},FBP{Marta.RadonAlgorithm.Filters.RamLak}},Marta.CTScan.CTImageData.CTData{Float64,Array{Float64,2}}},CircleImage{Float64},))
        end
    end
    let fbody = try __lookup_kwbody__(which(calibrate_tomogram, (CTScanner{FBPInfo{ParallelBeamGeometry{Float64,DefaultTomograph},FBP{Marta.RadonAlgorithm.Filters.RamLak}},Marta.CTScan.CTImageData.CTData{Float64,Array{Float64,2}}},GrayScaleLine{Float64},))) catch missing end
        if !ismissing(fbody)
            precompile(fbody, (Base.Iterators.Pairs{Union{},Union{},Tuple{},NamedTuple{(),Tuple{}}},typeof(calibrate_tomogram),CTScanner{FBPInfo{ParallelBeamGeometry{Float64,DefaultTomograph},FBP{Marta.RadonAlgorithm.Filters.RamLak}},Marta.CTScan.CTImageData.CTData{Float64,Array{Float64,2}}},GrayScaleLine{Float64},))
        end
    end
end
