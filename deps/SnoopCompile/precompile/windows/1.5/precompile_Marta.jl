...
function _precompile_()
    ...
    Base.precompile(Tuple{typeof(similar),MartaCT.CTScan.CTImageData.CTData{Float32,Array{Float32,2}},CTSinogram{Float32,Array{Float32,2}}})
    Base.precompile(Tuple{typeof(similar),MartaCT.CTScan.CTImageData.CTData{Float64,Array{Float64,2}},CTSinogram{Float64,Array{Float64,2}}})
