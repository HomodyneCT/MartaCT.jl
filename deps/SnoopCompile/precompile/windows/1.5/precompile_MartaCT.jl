...
function _precompile_()
    ...
    Base.precompile(Tuple{MartaCT.CTImages.var"#162#threadsfor_fun#13"{Float32,StepRangeLen{Float32,Float64,Float64},StepRangeLen{Float32,Float64,Float64},Float32,Float32,MartaCT.Interpolation.var"#1#2"{Array{Float32,2},MartaCT.Interpolation.BilinearInterpolation},Array{Tuple{Int64,Int64},1},Array{Float32,2},Base.OneTo{Int64}}})
    Base.precompile(Tuple{MartaCT.CTImages.var"#162#threadsfor_fun#13"{Float32,StepRangeLen{Float32,Float64,Float64},StepRangeLen{Float32,Float64,Float64},Float32,Float32,MartaCT.Interpolation.var"#1#2"{Array{Float32,2},MartaCT.Interpolation.NoInterpolation},Array{Tuple{Int64,Int64},1},Array{Float32,2},Base.OneTo{Int64}}})
    Base.precompile(Tuple{MartaCT.CTImages.var"#162#threadsfor_fun#13"{Float64,StepRangeLen{Float64,Base.TwicePrecision{Float64},Base.TwicePrecision{Float64}},StepRangeLen{Float64,Base.TwicePrecision{Float64},Base.TwicePrecision{Float64}},Float64,Float64,MartaCT.Interpolation.var"#1#2"{Array{Float64,2},MartaCT.Interpolation.BilinearInterpolation},Array{Tuple{Int64,Int64},1},Array{Float64,2},Base.OneTo{Int64}}})
    Base.precompile(Tuple{MartaCT.CTImages.var"#162#threadsfor_fun#13"{Float64,StepRangeLen{Float64,Base.TwicePrecision{Float64},Base.TwicePrecision{Float64}},StepRangeLen{Float64,Base.TwicePrecision{Float64},Base.TwicePrecision{Float64}},Float64,Float64,MartaCT.Interpolation.var"#1#2"{Array{Float64,2},MartaCT.Interpolation.NoInterpolation},Array{Tuple{Int64,Int64},1},Array{Float64,2},Base.OneTo{Int64}}})
    Base.precompile(Tuple{MartaCT.FanBeam.var"#193#threadsfor_fun#3"{Float32,Int64,Float32,StepRangeLen{Float32,Float64,Float64},StepRangeLen{Float32,Float64,Float64},CTSinogram{Float32,Array{Float32,2}},MartaCT.FanBeam.var"#compute_value#2"{Float32,Int64,Int64,Float32,Float32,Float32,MartaCT.Interpolation.var"#1#2"{CTSinogram{Float32,Array{Float32,2}},MartaCT.Interpolation.BilinearInterpolation},Float32},UnitRange{Int64}}})
    Base.precompile(Tuple{MartaCT.FanBeam.var"#193#threadsfor_fun#3"{Float64,Int64,Float64,StepRangeLen{Float64,Base.TwicePrecision{Float64},Base.TwicePrecision{Float64}},StepRangeLen{Float64,Base.TwicePrecision{Float64},Base.TwicePrecision{Float64}},CTSinogram{Float64,Array{Float64,2}},MartaCT.FanBeam.var"#compute_value#2"{Float64,Int64,Int64,Float64,Float64,Float64,MartaCT.Interpolation.var"#1#2"{CTSinogram{Float64,Array{Float64,2}},MartaCT.Interpolation.BilinearInterpolation},Float64},UnitRange{Int64}}})
    Base.precompile(Tuple{MartaCT.FanBeam.var"#216#threadsfor_fun#10"{Float32,Int64,Float32,StepRangeLen{Float32,Float64,Float64},Float32,StepRangeLen{Float32,Float64,Float64},CTSinogram{Float32,Array{Float32,2}},MartaCT.FanBeam.var"#compute_value#9"{Float32,Int64,Int64,Float32,Float32,Float32,MartaCT.Interpolation.var"#1#2"{CTSinogram{Float32,Array{Float32,2}},MartaCT.Interpolation.BilinearInterpolation},Float32},UnitRange{Int64}}})
    Base.precompile(Tuple{MartaCT.FanBeam.var"#216#threadsfor_fun#10"{Float64,Int64,Float64,StepRangeLen{Float64,Base.TwicePrecision{Float64},Base.TwicePrecision{Float64}},Float64,StepRangeLen{Float64,Base.TwicePrecision{Float64},Base.TwicePrecision{Float64}},CTSinogram{Float64,Array{Float64,2}},MartaCT.FanBeam.var"#compute_value#9"{Float64,Int64,Int64,Float64,Float64,Float64,MartaCT.Interpolation.var"#1#2"{CTSinogram{Float64,Array{Float64,2}},MartaCT.Interpolation.BilinearInterpolation},Float64},UnitRange{Int64}}})
    ...
    Base.precompile(Tuple{typeof(calibrate_tomogram),CTScanner{FBPInfo{ParallelBeamGeometry{Float64,DefaultTomograph},FBP{MartaCT.RadonAlgorithm.Filters.RamLak}},MartaCT.CTScan.CTImageData.CTData{Float64,Array{Float64,2}}},SquareImage{Float64}})
